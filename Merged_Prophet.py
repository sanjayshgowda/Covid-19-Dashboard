...
confirmed_forcast_plot=m.plot(forecast,figsize = (5.5,3.6))
#plt.legend()
...
plt.style.use('fivethirtyeight')
mplcursors.cursor(hover=True)
active_forcast_plot=m.plot(forecast,figsize = (5.5,3.6))
plt.legend()
plt.legend(prop={"size":8})
...
plt.style.use('fivethirtyeight')
mplcursors.cursor(hover=True)
death_forcast_plot=m.plot(forecast,figsize = (5.5,3.6))
plt.legend()
...
plt.style.use('fivethirtyeight')
mplcursors.cursor(hover=True)
recovered_forcast_plot=m.plot(forecast,figsize = (5.5,3.6))
plt.legend()
