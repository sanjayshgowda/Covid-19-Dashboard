...
df1['total_vaccinations'].plot(figsize = (5.5, 3.6), legend = True)
forecast.plot(figsize = (5.5, 3.6), legend = True)
...
vaccination_forcast_plot=m.plot(forecast,figsize = (5.5, 3.6))
#plt.legend()
plt.legend(prop={"size":8})
